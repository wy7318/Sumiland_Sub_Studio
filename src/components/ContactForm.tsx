    ...
    <section className="py-20 px-4 bg-gray-50" id="contact">
      <div className="max-w-6xl mx-auto">
        ...
        {success ? (
          ...
          >
            <h3 className="text-2xl font-semibold text-[#037ffc] mb-4">Thank You!</h3>
            <p className="text-gray-600 mb-8">
              We've received your message and will get back to you soon.
            </p>
            <button
              onClick={() => setSuccess(false)}
              className="px-6 py-2 bg-[#037ffc] text-white rounded-lg hover:bg-blue-600"
            >
          ...
          >
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-300 focus:border-[#037ffc] focus:ring-2 focus:ring-blue-200 outline-none"
                      placeholder="John"
                    />
                  </div>
                </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2 rounded-lg border border-gray-300 focus:border-[#037ffc] focus:ring-2 focus:ring-blue-200 outline-none"
                    required
                  >
                      ...
                      <div className="relative">
                        ...
                        <div 
                          ...
                          className={cn(
                            ...
                            formData.resume
                              ? "border-[#037ffc] bg-blue-50"
                              : "border-gray-300 hover:border-[#037ffc] hover:bg-gray-50"
                          )}
                        >
                          {formData.resume ? (
                            <div className="flex items-center justify-between">
                              <span className="text-[#037ffc]">{formData.resume.name}</span>
                              <button
                                type="button"
                                onClick={(e) => {
                                  e.stopPropagation();
                              ...
                              >
                                <X className="w-5 h-5 text-[#037ffc]" />
                              </button>
                            </div>
                          ) : (
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        >
                          {formData.attachment ? (
                            <div className="flex items-center justify-between">
                              <span className="text-[#037ffc]">{formData.attachment.name}</span>
                              <button
                                type="button"
                                onClick={(e) => {
                                  e.stopPropagation();
            ...
            <div className="flex justify-end">
              <button
                type="submit"
                disabled={loading}
                className="px-8 py-3 bg-[#037ffc] text-white rounded-lg hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
              >
